...
requireText('start-here.html', page, '<h3>Codex pattern accumulation</h3>');
forbidText('start-here.html', page, retiredModeQuestion);
forbidText('start-here.html', page, 'Seed Agent shows a harness-centered lineage');
forbidText('start-here.html', page, '<h3>Harness without a dashboard</h3>');
