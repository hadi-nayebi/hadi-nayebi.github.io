...
- **Three-family exit gate** — the per-phase advance filter that replaces the 100-point total: (a) metacog-coverage ≥N [hard], (b) marked-note coverage ≥M [soft], (c) required metacog subagent ran [hard]. CONDENSE additionally keeps its 80% deflation gate. _Avoid:_ "a point threshold," "exempts CONDENSE."
