...
window.DECK_INFO = {
        ...
        'b2-points': {
            ...
            what: 'Third check: did the job actually reflect on its own work this phase? The three-family gate requires that the CORE metacognition commands ran and at least one reflector subagent ran; new marked notes are also expected, but stay soft by default.',
