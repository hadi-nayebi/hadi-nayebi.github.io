...
<!-- IMAGE PLACEHOLDER:
  ...
  pastel chalk (cyan, green, orange — same palette as the cycle image) for the three Stage boxes;
  white chalk for labels, arrows, and branch notes; chalk sticks at the bottom edge; faint chalk dust at the edges.
