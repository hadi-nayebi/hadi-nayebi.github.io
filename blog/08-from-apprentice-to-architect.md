...
[Essay 5](05_1-the-two-layer-foundation.html) named the always-on layer and the CLAUDE.md bus it runs alongside. [Essay 6](06_1-phasic-foundation.html) named the phases that fill those compartments. [Essay 7](07_1-plugin-kit-foundation.html) named the cell template that lets new plugins be born.
...
*Previous: [The Plugin Kit](07_1-plugin-kit-foundation.html) — the anatomy of a plugin, and the discipline that lets the brain grow new ones safely.*
