...
[Essay 5](05_1-the-two-layer-foundation.html) named the always-on layer and the CLAUDE.md bus it runs alongside. [Essay 6](06_1-phasic-foundation.html) named the phases that fill those compartments. [Essay 7](07-the-plugin-kit.html) named the cell template that lets new plugins be born.
