...
The phasic plugins get their own series in [Essay 6](06_1-phasic-foundation.html). The cell template that lets new plugins be born safely is [Essay 7](07-the-plugin-kit.html). The four-stage arc from your first job to your first custom plugin is [Essay 8](08-from-apprentice-to-architect.html).
