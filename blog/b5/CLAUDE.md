...
**APPLIED (S-11→S-14).** All `.md` fixes done: 05_1 (F3+F5), 05_2 (6 F3), 05_3 (6 F1→%-of-window), 05_6 (3 F3), 05_7 (F2 + 4 F3 + L149 label). **KEY:** `.html` tags are hand-edited IN EXECUTE (VERIFY is read-only, regen script blocked here). `.html` surface status: **05_1 DONE**; **05_6 DONE (S-14** — 3 F3 summary-field strips: `line 135`, `capture.sh:85-131`, `gmode-gate.sh:54-63`**)**; **OWED: 05_2 (6 F3), 05_3 (6 F1), 05_7 (F2+4 F3+L149).** 05_9 own-eyes 1/3/5 still owed. F4 table→CONDENSE (above `---Ob---`); F5 candidates (05_7 L127/L155, 05_1 L138/L142/L184/L186)→VERIFY grep.
