...
- [Essay 8.2 — The Stages of Job Maturation](08_2-job-maturation-stages.html) — the three prototype Job Forms (single-cycle deep, multi-cycle `.md` plan, multi-cycle `.yaml` plan) plus the graduation arc into plugin form, sibling, and dependent jobs
