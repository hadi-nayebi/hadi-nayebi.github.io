...
[Essay 8.3](08_3-brain-after-three-months.html) closed the brain inventory at three months — a small brain over a large knowledge layer with a narrow memory. That shape is the *outcome*. One mechanism that helps produce it is the migration of behavioral controls from soft form to hard form across the harness, including the plugins that carry reusable controls. This essay opens that mechanism. *[ref: brain-maturation-soft-to-hard-canonical | private historical prototype | Checked against a private historical prototype; identifying repository, revision, source paths, and unpublished implementation details are omitted.]*
