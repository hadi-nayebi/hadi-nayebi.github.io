...
Now think about another complex system: the brain. In the [Thousand Brains hypothesis](https://www.frontiersin.org/journals/neural-circuits/articles/10.3389/fncir.2018.00121/full), Jeff Hawkins and colleagues describe cortical columns as association engines — mapping what they sense to what they expect, much the way an LLM maps prior words to likely next words. Whether or not every detail of that theory holds, its architectural picture is useful here. Intelligence did not emerge from one enormous super-column. It emerged through many interacting circuits, specialized regions, and coordinated subsystems.
